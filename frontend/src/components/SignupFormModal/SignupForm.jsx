...
//               <button
//                 type="submit"
//                 className={`block w-full bg-green-400 hover:bg-green-600 text-white py-2 px-4 rounded-md  focus:outline-none focus:ring-2 focus:ring-opacity-50 ${loading ? 'opacity-50 cursor-not-allowed' : ''}`} // Apply opacity and cursor style based on loading state
//               >
        ...
        <div className="bg-white rounded-2xl p-8 w-1/3">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <button
                type="submit"
                className={`block w-full  text-white py-2 px-4 rounded-md bg-green-400 hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-opacity-50 ${loading ? 'opacity-50 cursor-not-allowed' : ''}`} // Apply opacity and cursor style based on loading state
              >
                {loading ? 'Signing Up...' : 'Sign Up'}
              </button>
            </div>
