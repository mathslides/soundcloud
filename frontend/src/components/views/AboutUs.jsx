      ...
      <div className="flex-grow mb-20 mt-4">
        <div className="container mx-auto flex flex-col lg:flex-row items-center">
          <div className="w-full lg:w-1/2 flex flex-col justify-center bg-black bg-opacity-75 p-10 text-white">
            <h2 className="text-3xl lg:text-5xl lg:pt30 font-bold mb-6">
              Fostering Creative Unity
            </h2>
            <h2 className="text-lg lg:text-2xl font-bold mb-6">
              Inspiring Artists, Building Community
            </h2>
            <p className="text-sm lg:text-base mb-4">
              Calisomnia is a platform dedicated to showcasing the talents of
              artists across Africa. Our mission is to provide a space where
              artists can express themselves, share their creativity, and
              connect with a broader audience.
            </p>
            <p className="text-sm lg:text-base mb-4">
              At Calisomnia, we believe that every artist deserves recognition
              and support. Whether you're a musician, painter, dancer, writer,
              or any other type of artist, we welcome you to join our community
